...
export default function CreateLaboratoryModal({ open, onSave, onClose, loading: loadingProp = false }) {
  ...
  return (
    <MuiModal open={open} onClose={onClose} maxWidth="max-w-2xl">
      <CardWithTitle title="Crear Laboratorio" loading={loadingProp}>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="col-span-1 sm:col-span-2 flex justify-end gap-2 pt-2">
            <CreateButton type="submit" title={saving ? 'Guardando...' : 'Crear Laboratorio'} />
